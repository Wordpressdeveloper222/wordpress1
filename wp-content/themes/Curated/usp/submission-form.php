...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" enctype="multipart/form-data" data-parsley-validate action="">
		...
		<fieldset class="usp-category">
			...
			<!--select id="user-submitted-category1" name="user-submitted-category1"<?php if (usp_check_required('usp_category')) echo $usp_required; ?> class="usp-select">
			...
			<?php foreach($usp_options['categories'] as $categoryId) { $category = get_category($categoryId); if (!$category) { continue; }  ?>
		<input type="checkbox"  id="user-submitted-category[]"  <?php if (usp_check_required('usp_category')) echo $usp_required; ?> class="usp-select" name="user-submitted-category" value="<?php echo $categoryId; ?>" /><?php $category = get_category($categoryId); echo sanitize_text_field($category->name); ?><br /> <?php } ?>
		</fieldset>
		...
		<div id="usp-submit">
			...
			<?php echo implode(",",$usp_options['usp_use_cat_id']); exit;?>
		</div>
		<?php endif; ?>
