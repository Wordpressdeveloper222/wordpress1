...
<div id="buddypress">
	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul>
			...
			<li id="photos-all"><a href="<?php echo esc_url( $global_media_permalink );?>"><?php _e( 'All Photos', 'boss' );?></a></li>
			<li class="selected" id="albums-personal"><a href="<?php echo esc_url( $global_media_permalink );?>albums/"><?php _e( 'All Albums', 'boss' );?></a></li>
		</ul>
	</div>
	...
	<div id="albums-dir-list" class="albums dir-list">
				...
				<li id='album-<?php echo buddyboss_media_album_id();?>'>
					<div class="item-avatar">
						<a href='<?php buddyboss_media_album_permalink();?>'>
							<?php buddyboss_media_album_avatar( 'width=70&height=70' ); ?>
						</a>
					</div>
		...
		<?php else: ?>
			...
			<div id="message" class="info">
				<p><?php _e( 'There were no albums found.', 'boss' ); ?></p>
			</div>
