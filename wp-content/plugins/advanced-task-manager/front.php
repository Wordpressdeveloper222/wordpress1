...
$upload_dir = wp_upload_dir();	?>
  ...
  xhr.open("POST","<?php bloginfo('url') ?>/wp-admin/async-upload.php",true);
  xhr.send(formData);
}
	  function savedata()
{
...
/* 	var path = "C:\fakepath\";
 var field_5 = path.replace(/^.*\\/, ""); */
	...
	var field_5 = '<?php echo site_url().'/'; ?>'+'wp-content/uploads/2017/01/'+jQuery('#file').val().replace(/C:\\fakepath\\/i, '');
