...
if(isset($_POST['act_type']) && $_POST['act_type'] == 'worldcountries-html5-map-points-save') {
...
echo "<div class=\"wrap\"><h2>" . __('Configuration of Map points', 'worldcountries-html5-map') . "</h2>";
?>
<style>
.tipsy-w {
    z-index: 100500;
...
<script>
    ...
    $('select[name=map_id],select[name=state_select]').change(function() {
        ...
        s_id = $('select[name=state_select] option:selected').val();
            ...
            location.href='admin.php?page=worldcountries-html5-map-points&map_id='+$('select[name=map_id] option:selected').val()+'&s_id='+s_id;
        });
...
<form method="POST" class="worldcountries-html5-map main" onsubmit="adjustSubmit()">
    ...
    <?php worldcountries_html5map_plugin_nav_tabs('points', $map_id); ?>

    <p><?php _e("Double-click to add a point; click and hold to drag; double-click a point to edit it", "worldcountries-html5-map"); ?></p>

    <fieldset>
        <legend><?php echo __('Points Configuration', 'worldcountries-html5-map'); ?></legend>

        <div id="point_info"></div>
        <div>
        <div style="border-top: 1px solid #ddd">
                <label style="position: relative; top: -13px; background: white"><a href="javascript:void(0);" onclick="show_default_options(this.innerHTML.indexOf('+')!==-1)"><?php echo sprintf(__("Points defaults [%s]", "worldcountries-html5-map"), "<span>+</span>") ?></a></label>
                <div id="pointDefOptionsWrapp" style="display: none">
                <table style="width: 100%">
                    <thead>
                    <tr style="font-weight: bold">
                        <td><?php echo __('Option', 'worldcountries-html5-map'); ?></td>
                        <td><?php echo __('Common color', 'worldcountries-html5-map'); ?></td>
                        <td><?php echo __('Hover color', 'worldcountries-html5-map'); ?></td>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td><?php echo __('Point color:', 'worldcountries-html5-map'); ?></td>
                        ...
                        <span class="tipsy-q" original-title='<?php esc_attr_e('The color of a point.', 'worldcountries-html5-map'); ?>'>[?]</span><div class="colorpicker" style="margin-left: 100px"></div>
                        </td>
                        ...
                        <span class="tipsy-q" original-title='<?php esc_attr_e('The color of a point when the mouse cursor is over it.', 'worldcountries-html5-map'); ?>'>[?]</span><div class="colorpicker" style="margin-left: 100px"></div>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo __('Border color:', 'worldcountries-html5-map'); ?></td>
                        ...
                        <span class="tipsy-q" original-title='<?php esc_attr_e('The color of a point border.', 'worldcountries-html5-map'); ?>'>[?]</span><div class="colorpicker" style="margin-left: 100px"></div></td>
                        ...
                        <span class="tipsy-q" original-title='<?php esc_attr_e('The color of a point border when the mouse cursor is over it.', 'worldcountries-html5-map'); ?>'>[?]</span><div class="colorpicker" style="margin-left: 100px"></div></td>
                    </tr>
                    <tr>
                        <td><?php echo __('Shortname color:', 'worldcountries-html5-map'); ?></td>
                        ...
                        <span class="tipsy-q" original-title='<?php esc_attr_e('The color of a point\'s shortname.', 'worldcountries-html5-map'); ?>'>[?]</span><div class="colorpicker" style="margin-left: 100px"></div></td>
                        ...
                        <span class="tipsy-q" original-title='<?php esc_attr_e('The color of a point\'s shortname when the mouse cursor is over it.', 'worldcountries-html5-map'); ?>'>[?]</span><div class="colorpicker" style="margin-left: 100px"></div></td>
                    </tr>
                    <tr>
                        <td><?php echo __('Shortname stroke color:', 'worldcountries-html5-map'); ?></td>
                        ...
                        <span class="tipsy-q" original-title='<?php esc_attr_e('The color of a point\'s shortname stroke.', 'worldcountries-html5-map'); ?>'>[?]</span><div class="colorpicker" style="margin-left: 100px"></div></td>
                        ...
                        <span class="tipsy-q" original-title='<?php esc_attr_e('The color of a point\'s shortname stroke when the mouse cursor is over it.', 'worldcountries-html5-map'); ?>'>[?]</span><div class="colorpicker" style="margin-left: 100px"></div></td>
                    </tr>
                    </tbody>
                </table>
        </div>
    ...
    <div style="display: none" id="dialogs">
        ...
        ?>
            <div style="float: left; width: <?php echo $w ?>%;">
                <label><span class="title" style="width: 80px"><?php echo __('Point type:', 'worldcountries-html5-map') ?> </span><select name="pointType" id="pointType" >
                <?php foreach ($pointTypes as $pt => $pn) { ?>
                <option value="<?php echo $pt ?>"><?php _e($pn, 'worldcountries-html5-map') ?></option>
                <?php } ?>
                </select></label>
                <span class="tipsy-q" original-title="<?php esc_attr_e('Point type', 'worldcountries-html5-map'); ?>">[?]</span><br />
            </div>
        <?php } ?>
            <div style="float: left; width: <?php echo $w ?>%;">
                <label><span class="title" style="width: 80px"><?php echo __('X position:', 'worldcountries-html5-map') ?> </span><input type="text" name="pointX" id="pointX" value="0" style="width: 50px"/></label>
                <span class="tipsy-q" original-title="<?php esc_attr_e('X position of the point', 'worldcountries-html5-map'); ?>">[?]</span><br />
            </div>
            <div style="float: left; width: <?php echo $w ?>%;">
                <label><span class="title" style="width: 80px"><?php echo __('Y position:', 'worldcountries-html5-map') ?> </span><input type="text" name="pointY" id="pointY" value="0" style="width: 50px"/></label>
                <span class="tipsy-q" original-title="<?php esc_attr_e('Y position of the point', 'worldcountries-html5-map'); ?>">[?]</span><br />
            </div>
            <div style="float: left; width: <?php echo $w ?>%;">
                <label><span class="title" style="width: 80px"><?php echo __('Radius:', 'worldcountries-html5-map') ?> </span><input type="number" name="pointRadius" id="pointRadius" value="4" style="width: 50px" min="1" max="<?php echo $maxRadius ?>"/></label>
                <span class="tipsy-q" original-title="<?php esc_attr_e('Radius of the point', 'worldcountries-html5-map'); ?>">[?]</span><br />
            </div>
            <hr style="clear: both"/>
            <div style="float:left; min-width: 500px">
            <label><span class="title"><?php echo __('Name:', 'worldcountries-html5-map') ?> </span><input type="text" name="pointName" id="pointName" value=""/></label>
            <span class="tipsy-q" original-title="<?php esc_attr_e('This name will be show when mouse will be over this point', 'worldcountries-html5-map'); ?>">[?]</span><br />
            <label><span class="title"><?php echo __('Short name:', 'worldcountries-html5-map') ?> </span><input type="text" name="pointShortname" id="pointShortname" value="" /></label>
            <span class="tipsy-q" original-title="<?php esc_attr_e('This name will be show near point on the map', 'worldcountries-html5-map'); ?>">[?]</span><br />
            </div>
            <div style="float:left; min-width: 500px">
            <label><span class="title"><?php echo __('Text position:', 'worldcountries-html5-map') ?></span><select name="pointTextPos" id="pointTextPos" style=" width: 190px">
                <option value="left-top"><?php echo __('Left Top', 'worldcountries-html5-map') ?></option>
                <option value="left-middle"><?php echo __('Left Middle', 'worldcountries-html5-map') ?></option>
                <option value="left-bottom"><?php echo __('Left Bottom', 'worldcountries-html5-map') ?></option>
                <option value="middle-top"><?php echo __('Center Top', 'worldcountries-html5-map') ?></option>
                <option value="middle-middle"><?php echo __('Center Middle', 'worldcountries-html5-map') ?></option>
                <option value="middle-bottom"><?php echo __('Center Bottom', 'worldcountries-html5-map') ?></option>
                <option value="right-top"><?php echo __('Right Top', 'worldcountries-html5-map') ?></option>
                <option value="right-middle"><?php echo __('Right Middle', 'worldcountries-html5-map') ?></option>
                <option value="right-bottom"><?php echo __('Right Bottom', 'worldcountries-html5-map') ?></option>
            </select></label>
            <span class="tipsy-q" original-title="<?php esc_attr_e('Shortname position relative to the point', 'worldcountries-html5-map'); ?>">[?]</span>
            <br/>
            <label><span class="title"><?php echo __('Font size:', 'worldcountries-html5-map'); ?></span><input type="number" name="pointFS" id="pointFS" min="3" max="20" style="width: 190px"/> px
            <span class="tipsy-q" original-title='<?php echo __('Font size of the shortname displayed near the point.', 'worldcountries-html5-map'); ?>'>[?]</span>&nbsp;&nbsp;&nbsp;</label>
            <label for="pointFSDef"><input name="pointFSDef" id="pointFSDef" type="checkbox" /> <?php echo __('Use default', 'worldcountries-html5-map'); ?></label>
            <br />
            </div>
            <div style="clear: both"></div>

            <div style="border-top: 1px solid #ddd">
                <label style="position: relative; top: -13px; background: white"><a href="javascript:void(0);" onclick="show_comment(this.innerHTML.indexOf('+')!==-1)"><?php echo sprintf(__("Tooltip [%s]", "worldcountries-html5-map"), "<span>+</span>") ?></a></label>
                <div id="pointCommentWrapp">
                    ...
                    <span style="font-size: 10px; cursor: pointer;" onclick="jQuery('#pointImage').val('')"><?php echo __('clear', 'worldcountries-html5-map'); ?></span>
            ...
            <div style="float:left; min-width: 500px">
            <span class="title"><?php echo __('Point color:', 'worldcountries-html5-map'); ?> </span><input class="color colorSimple" type="text" name="pointColor" id="pointColor" value="" style="background-color: white"  />
            <span class="tipsy-q" original-title='<?php esc_attr_e('The color of a point.', 'worldcountries-html5-map'); ?>'>[?]</span><div class="colorpicker"></div>
            <label for="colorDef"><input name="colorDef" id="colorDef" class="colorOverCh" type="checkbox" /> <?php echo __('Use default', 'worldcountries-html5-map'); ?></label>
            <br />
            </div>
            <div style="float:left; min-width: 500px">
            <span class="title"><?php echo __('Point hover color:', 'worldcountries-html5-map'); ?> </span><input class="color colorOver" type="text" name="pointColorOver" id="pointColorOver" style="background-color: white"  />
            <span class="tipsy-q" original-title='<?php echo __('The color of a point when the mouse cursor is over it.', 'worldcountries-html5-map'); ?>'>[?]</span><div class="colorpicker"></div>
            <label for="colorOverDef"><input name="colorOverDef" id="colorOverDef" class="colorOverCh" type="checkbox" /> <?php echo __('Use default', 'worldcountries-html5-map'); ?></label>
            <br />
            </div>
            <hr style="clear: both"/>
            <span class="title"><?php echo __('On click action:', 'worldcountries-html5-map'); ?> </span>
            <label><input type="radio" name="clickaction" id="ca-nothing" value="nothing" checked="checked" autocomplete="off"/> <?php echo __('nothing', 'worldcountries-html5-map') ?></label>&nbsp;&nbsp;&nbsp;
            <label><input type="radio" name="clickaction" id="ca-url"     value="url"  autocomplete="off"/> <?php echo __('open link', 'worldcountries-html5-map') ?></label>&nbsp;&nbsp;&nbsp;
            <label><input type="radio" name="clickaction" id="ca-info"    value="info" autocomplete="off"/> <?php echo __('show additional information', 'worldcountries-html5-map') ?></label>&nbsp;&nbsp;&nbsp;
            <label><input type="radio" name="clickaction" id="ca-popup"   value="popup" autocomplete="off" <?php echo (!count($popups)) ? "disabled" : ""; ?>/> <?php echo __('Show lightbox popup', 'worldcountries-html5-map') ?></label>&nbsp;&nbsp;&nbsp;
            <br>
            <div id="action-url" style="display: none">
            <hr style="clear: both"/>
                <span class="title"><?php echo __('URL:', 'worldcountries-html5-map'); ?> </span><input style="width: 270px;" class="" type="text" name="pointURL" id="pointURL" value="" />
                <span class="tipsy-q" original-title="<?php esc_attr_e('Open url on click (if specified)', 'worldcountries-html5-map'); ?>">[?]</span></br>
                <span class="title"> </span>
                <label for="pointURLNW"><input name="pointURLNW" id="pointURLNW" class="" type="checkbox" /> <?php echo __('Open url in a new window', 'worldcountries-html5-map'); ?></label>
            </div>
...
?>
    <script>
        ...
        jQuery(function($){
            var btnAdd = {
                'text': '<?php _e("Add", "worldcountries-html5-map"); ?>',
                'icons': {
            ...
            var btnSave = {
                'text': '<?php _e("Apply", "worldcountries-html5-map"); ?>',
                'icons': {
            ...
            var btnDelete = {
                'text': '<?php _e("Delete", "worldcountries-html5-map"); ?>',
                'icons': {
                    'primary': 'ui-icon-delete'
                },
                'click' : function() {
                    var name = map.fetchPointAttr(activePoint, 'name');
                    if (confirm('<?php _e("Are you sure you want to delete point", "worldcountries-html5-map") ?> '+name)) {
            ...
            var btnClose = {
                'text': '<?php _e("Cancel", "worldcountries-html5-map"); ?>',
                'icons': {
            ...
            map.on('dblclick', function(ev, sid, map){
                ...
                if (sid && map.mapConfig.points[sid]) {
                    ...
                    dlg.dialog('option', {
                        'title': '<?php _e("Edit point: %s", "worldcountries-html5-map") ?>'.replace('%s', p.name),
                    ...
                    dlg.dialog('option', {
                        'title': '<?php _e("Add new point", "worldcountries-html5-map") ?>',
            ...
            var dlg = $('#point_cfg').dialog({
                ...
                'width': '80%',
                'autoOpen': false,
                'dialogClass': 'worldcountries-html5-map',
                'buttons': []
            });
    ...
    <input type="hidden" name="act_type" value="worldcountries-html5-map-points-save" />
    <input type="hidden" name="map_points"  id="map_points"  />
    <input type="hidden" name="points_info" id="points_info" />
    <p class="submit"><input type="submit" value="<?php esc_attr_e('Save Changes', 'worldcountries-html5-map'); ?>" class="button-primary" id="submit" name="submit" disabled></p>
</form>
</div>
