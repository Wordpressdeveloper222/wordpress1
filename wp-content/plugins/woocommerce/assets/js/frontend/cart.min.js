    ...
    var b = function(a) {
        ...
        f = function(b) {
            ...
            if (a(".woocommerce-error, .woocommerce-message, .woocommerce-info").remove(), 0 === d.length) {
                ...
                a(".shop_table.cart").closest(".woocommerce").replaceWith(k), f.length > 0 && h(f, a(".cart-empty").closest(".woocommerce")), i.length > 0 && h(i, a(".cart-empty").closest(".woocommerce")), j.length > 0 && h(j, a(".cart-empty").closest(".woocommerce"))
            } else a(".woocommerce-checkout").length && a(document.body).trigger("update_checkout"), a(".shop_table.cart").closest("form").replaceWith(d), a(".shop_table.cart").closest("form").find('input[name="update_cart"]').prop("disabled", !0), f.length > 0 && h(f), i.length > 0 && h(i), j.length > 0 && h(j), g(e);
        ...
        h = function(b, c) {
            c || (c = a(".shop_table.cart").closest("form")), c.before(b)
        },
        i = {
            init: function(b) {
        ...
        j = {
            ...
            cart_submit: function(b) {
                var d = a(document.activeElement),
                    ...
                    f = a(b.currentTarget);
                return f.is("form") || (f = a(b.currentTarget).parents("form")), 0 !== f.find(".shop_table.cart").length && (!c(f) && void(e.is('[name="update_cart"]') || d.is("input.qty") ? (b.preventDefault(), this.quantity_update(f)) : (e.is('[name="apply_coupon"]') || d.is("#coupon_code")) && (b.preventDefault(), this.apply_coupon(f))))
            },
            ...
            apply_coupon: function(c) {
                ...
                a.ajax({
                    ...
                    dataType: "html",
                    success: function(b) {
                        a(".woocommerce-error, .woocommerce-message, .woocommerce-info").remove(), h(b), a(document.body).trigger("applied_coupon")
                    },
                    complete: function() {
            ...
            remove_coupon_clicked: function(c) {
                ...
                a.ajax({
                    ...
                    dataType: "html",
                    success: function(b) {
                        a(".woocommerce-error, .woocommerce-message, .woocommerce-info").remove(), h(b), a(document.body).trigger("removed_coupon"), e(g.parents("table"))
                    },
                    complete: function() {
